...
questions_list = [] 
questions_list.append(Question('сколько героев в смешариках', '9', '10', '11', '12'))
questions_list.append(Question('какого цвета персонаж крош', 'голубой ', 'черный', 'белый', 'красный'))
questions_list.append(Question('чем занимается Пин', 'изобретательством', 'футболом', 'творчеством', 'баскетболом'))
